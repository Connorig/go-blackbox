...
### Docs
- standalone SMS and mail service guides

## v1.95.0 - 2026-08-25

### Docs
- i18n hot reload section

## v1.94.0 - 2026-08-25

### Added
- i18n language resource hot reload via WatchDir

## v1.93.0 - 2026-08-25

### Docs
- grayscale stats observability section

## v1.92.0 - 2026-08-25

### Added
- grayscale stats HTTP handler

## v1.91.0 - 2026-08-25

### Docs
- eventbus guide and module registry updates

## v1.90.0 - 2026-08-25

### Added
- eventbus subscriber retry with exponential backoff

## v1.89.0 - 2026-08-25

### Added
- audit query management page

## v1.88.0 - 2026-08-25

### Docs
- rate limiter and language middleware guides

## v1.87.0 - 2026-08-25

### Added
- notify rate limiter against SMS bombarding

## v1.86.0 - 2026-08-25

### Changed
- gofmt compliance for middleware.go trailing newline

## v1.85.0 - 2026-08-25

### Added
- webiris Language middleware for i18n requests

## v1.84.0 - 2026-08-25

### Added
- default PanicRecovery middleware + CI race detection

## v1.83.0 - 2026-08-25

### Changed
- gofmt formatting pass across repository

## v1.82.0 - 2026-08-25

### Added
- goroutine panic governance across async paths

## v1.81.0 - 2026-08-25

### Fixed
- shutdown sync EBADF + datasource lifecycle trap + CI matrix

## v1.80.0 - 2026-08-25

### Fixed
- env override camel-case convention + darwin monitor

## v1.79.0 - 2026-08-20

### Docs
- i18n and notify center guidelines

## v1.78.0 - 2026-08-20

### Added
- i18n bundle with dir loading and lang detection

## v1.77.0 - 2026-08-20

### Added
- notify template registry with placeholder render

## v1.76.0 - 2026-08-20

### Added
- grayscale observability, header tag and stats

## v1.75.0 - 2026-08-20

### Docs
- redqueue guide + configcenter cached client docs

## v1.74.0 - 2026-08-20

### Added
- configcenter cached client with subscribe

## v1.73.0 - 2026-08-20

### Added
- redqueue dead-letter hook for alerting

## v1.72.0 - 2026-08-20

### Docs
- grayscale and config center guidelines

## v1.71.0 - 2026-08-20

### Added
- redqueue retry limit and dead-letter queue

## v1.70.0 - 2026-08-19

### Added
- audit query HTTP handler + README registry

## v1.69.0 - 2026-08-19

### Added
- notify channel adapters for sms/mail

## v1.68.0 - 2026-08-19

### Added
- oplog Redis storage with query + RBAC guide
...
### Added
- eventbus Redis bridge for cross-instance events

## v1.65.0 - 2026-08-19

### Added
- Redis reliable task queue

## v1.64.0 - 2026-08-19

### Added
- RBAC role-permission enforcement layer

## v1.63.0 - 2026-08-19

### Added
- task queue, live signature/dvr, grayscale, config center

## v1.62.0 - 2026-08-18

### Fixed
- env override regression tests (Bug 7)

## v1.61.0 - 2026-08-18

### Added
- excel validated import and streaming import

## v1.60.0 - 2026-08-18

### Added
- database pool stats and module index docs

## v1.59.0 - 2026-08-18

### Added
- file upload and captcha modules

## v1.58.0 - 2026-08-18

### Added
- online counter and redis token bucket rate limit

## v1.57.0 - 2026-08-18

### Added
- sensitive word filter and unified validation

## v1.56.0 - 2026-08-18

### Added
- idempotent guard and ws cross-node broadcast

## v1.55.0 - 2026-08-17

### Added
- excel export filename with timestamp and RFC 5987 encoding

## v1.54.0 - 2026-08-17

### Added
- excel multi-sheet, batch writing, import with errors

## v1.53.0 - 2026-08-17

### Added
- excel template import/export and influx CLI templates

## v1.52.0 - 2026-08-17

### Added
- ws room-scoped pub/sub with lifecycle callbacks

## v1.51.0 - 2026-08-16

### Fixed
- real listen address logging and compact iris route table

## v1.50.0 - 2026-08-16

### Added
- live named client registry for multi-SRS clusters

## v1.49.0 - 2026-08-16

### Fixed
- apidoc page method key case and version prefix

## v1.48.0 - 2026-08-16

### Added
- unified zap logging for iris, gorm and stdlib

## v1.47.0 - 2026-08-16

### Fixed
- normalize DSN to URL format - root fix for special-char passwords
## v1.46.0 - 2026-08-16
