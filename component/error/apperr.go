...
func Newf(httpStatus int, code Code, format string, args ...interface{}) *Error {
	return &Error{HTTPStatus: httpStatus, Code: code, Message: fmt.Sprintf(format, args...)}
}
...
func From(err error) *Error {
	...
	return &Error{HTTPStatus: http.StatusInternalServerError, Code: CodeInternal, Message: "internal server error", Cause: err}
}
